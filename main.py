...
def Excel2Json(file_path):
    ...
    if get_data(file_path) is not None:
        ...
        json_data = json.dumps(result, indent=4, sort_keys=True,ensure_ascii=False,encoding='utf-8').decode('unicode_escape')
...
if __name__ == '__main__':
    ...
    json_data = Excel2Json('sheet1.xlsx')